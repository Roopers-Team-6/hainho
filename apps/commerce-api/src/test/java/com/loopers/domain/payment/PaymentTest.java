...
class PaymentTest {
    ...
    class CreatePayment {
        ...
        void createPaymentWithNullOrderId() {
            // arrange
            PaymentCommand.Create command = new PaymentCommand.Create(null, VALID_PAYMENT_METHOD, VALID_AMOUNT);
        ...
        void createPaymentWithNullPaymentMethod() {
            // arrange
            PaymentCommand.Create command = new PaymentCommand.Create(VALID_ORDER_ID, null, VALID_AMOUNT);
        ...
        void createPaymentWithInvalidPaymentMethod() {
            // arrange
            PaymentCommand.Create command = new PaymentCommand.Create(VALID_ORDER_ID, "invalidPaymentMethod", VALID_AMOUNT);
        ...
        void createPaymentWithNullAmount() {
            // arrange
            PaymentCommand.Create command = new PaymentCommand.Create(VALID_ORDER_ID, VALID_PAYMENT_METHOD, null);
        ...
        void createPaymentWithZeroOrNegativeAmount() {
            // arrange
            PaymentCommand.Create command = new PaymentCommand.Create(VALID_ORDER_ID, VALID_PAYMENT_METHOD, 0L);
    ...
    class CompletePayment {
        ...
        void completePaymentWithNullTransactionKey() {
            // arrange
            Payment payment = Payment.create(new PaymentCommand.Create(VALID_ORDER_ID, VALID_PAYMENT_METHOD, VALID_AMOUNT));
